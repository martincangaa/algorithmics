...
def draw_coloured_map(graph : dict[str, any], colours : dict[str, str]) -> None:
    G = nx.Graph()
...
if __name__ == "__main__":
    ...
    n = 4
    for i in range(1,(int)( math.log2(65536))):
        ...
        print('Number of nodes: %d (%f ms)' %(n, t))
